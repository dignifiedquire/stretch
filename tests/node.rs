...
mod node {
    ...
    use stretch::node::{Stretch, StretchNode};
    use stretch::style::*;

    #[test]
    fn children() {
        let mut stretch = Stretch::new();
        let child1: StretchNode = stretch.new_node(Style::default(), vec![]).unwrap();
        let child2: StretchNode = stretch.new_node(Style::default(), vec![]).unwrap();
    ...
    fn set_measure() {
        ...
        let node: StretchNode =
            stretch.new_leaf(Style::default(), Box::new(|_| Ok(Size { width: 200.0, height: 200.0 }))).unwrap();
    ...
    fn add_child() {
        let mut stretch = Stretch::new();
        let node: StretchNode = stretch.new_node(Style::default(), vec![]).unwrap();
    ...
    fn remove() {
        ...
        let node2: StretchNode = stretch.new_node(style2, vec![]).unwrap();
    ...
    fn remove_last_node() {
        ...
        let parent: StretchNode = stretch.new_node(Style::default(), vec![]).unwrap();
